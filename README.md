...
### 15. HTML Templating language는 무엇이고 어떤 것들이 있는가?
...
### 21. 내장 JavaScript 객체를 확장하는 것이 좋지 않은 이유는 무엇인가?
...
### 25. 삼항식(Ternary statement)에 대해 설명하시오.

### 27. use strict에 대해 설명하시오.

### 28. 전역 Scope를 사용했을 때 장/단점은 무엇인가?

...
### 11. prototype 기반 상속에 대해 설명하시오.

### 12. AMD와 CommonJS는 무엇이고, 이것들에 대해 어떻게 생각하는가?

### 13. IIFE로 만들기 위해서는 어떻게 해야 하는가?

### 14. null과 undefined 그리고 undeclared의 차이점은 무엇인가?

### 15. 익명함수(anonymous functions)는 주로 어떤 상황에서 사용하는가?

### 16. 호스트 객체와 네이티브 객체의 차이점은 무엇인가?

### 17. .call과 .apply의 차이점은 무엇인가?

### 18. Function.prototype.bind에 대해 설명하시오.

### 19. document.write()는 언제 사용하는가?

### 20. JSON이 동작원리에 대해 설명하시오.
